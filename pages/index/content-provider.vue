            ...
            <div class="grid grid-cols-2 bg-white rounded-md p-6 gap-4">
              ...
              <div class="col-span-2">
                ...
                <textarea
                  ...
                  :placeholder="$t('short-summary-of-agricultural-environmental-experience-and-activities-of-organization-in-Karakalpakstan')"
                  class="focus:outline-none appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 sm:text-sm"
                />
              </div>
              <div class="col-span-2">
                ...
                <textarea
                  ...
                  :placeholder="$t('short-description-of-organization-size-relationship-to-agricultural-environmental-sectors-in-Karakalpakstan')"
